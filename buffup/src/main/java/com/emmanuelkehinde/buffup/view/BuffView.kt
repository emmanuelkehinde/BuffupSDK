...
import com.emmanuelkehinde.buffup.exceptions.UnsupportedActivityViewGroupException
...
class BuffView(context: Context, attrs: AttributeSet): LinearLayout(context, attrs) {
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.BuffView,
            ...
            try {
                //Header Items
                authorInfoBackground = getDrawable(R.styleable.BuffView_buff_author_info_background)
                ...
                closeIcon = getDrawable(R.styleable.BuffView_buff_close_icon)
                ...
                questionBackground = getDrawable(R.styleable.BuffView_buff_question_background)

                //Answer Items
                answerRowBackground = getDrawable(R.styleable.BuffView_buff_answer_row_background)
                answerRowTextColor = getColor(
                    R.styleable.BuffView_buff_answer_row_text_color,
                    ContextCompat.getColor(context, DEFAULT_DARK_TEXT_COLOR)
                )
                selectedAnswerRowBackground = getDrawable(R.styleable.BuffView_buff_selected_answer_row_background)
                selectedAnswerRowTextColor = getColor(
                    R.styleable.BuffView_buff_selected_answer_row_text_color,
                    ContextCompat.getColor(context, DEFAULT_LIGHT_TEXT_COLOR)
                )
            } finally {
                recycle()
